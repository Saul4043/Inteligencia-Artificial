# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 22:58:18 2023
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if prev_hand_landmarks:
                ...
                cv2.putText(frame, f'Dedos Levantados: {raised_fingers}', (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
                # Mostrar las señas de mano con letras
                
            # Almacenar la posición actual de la mano para la próxima iteracción
